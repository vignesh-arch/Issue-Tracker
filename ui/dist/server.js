...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "84529b50823218102bd6";
...
function Contents() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Switch"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Redirect"], {
    ...
    from: "/",
    to: "/issues"
  }), _routes_js__WEBPACK_IMPORTED_MODULE_2__["default"].map(attr => {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Route"], _extends({}, attr, {
      key: attr.path
    }));
  }));
}
...
class IssueFilter extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor({
    ...
    const _params = new url_search_params__WEBPACK_IMPORTED_MODULE_2___default.a(_search);
    super();
    _defineProperty(this, "onChangeStatus", e => {
      this.setState({
        status: e.target.value,
        changed: true
      });
    });
    _defineProperty(this, "onApplyFilter", e => {
      const {
        status,
        effortMin,
        effortMax
    ...
    this.state = {
      status: _params.get('status') || '',
      effortMin: _params.get('effortMin') || '',
      effortMax: _params.get('effortMax') || '',
      changed: false
    };
...
function IssueReport() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, " This is placeholder for IssueReport "));
}
...
const IssueRow = Object(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["withRouter"])(({
  issue,
  location: {
    search
  },
...
async function graphQLFetch(query, variables = {}, showError = null) {
  ...
  try {
    ...
    if (showError) showError(`Error in sending data to server :${error.message}`);
    return null;
  }
}
